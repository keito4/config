...
以下のケースでContext7を使用する：

| トリガー                               | 例                                   |
| -------------------------------------- | ------------------------------------ |
| ライブラリの使い方を聞かれた時         | 「Prismaのマイグレーション方法は？」 |
| フレームワークの設定方法               | 「Next.js 14のApp Router設定」       |
| 新機能・変更点の確認                   | 「React 19の新機能は？」             |
| エラー解決でドキュメント参照が必要な時 | 「このTailwindエラーの解決方法」     |
| バージョン固有の情報が必要な時         | 「Vite 5の設定ファイル形式」         |
