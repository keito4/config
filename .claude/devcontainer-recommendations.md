...
**推奨アプローチ**: 独立した`pnpm:2` Featureを使用することで、Node.jsとpnpmのバージョン管理を分離し、より明確で保守しやすい構成が可能になります。特にpnpmのバージョン管理を厳密に行いたい場合や、Node.jsのバージョンを変更してもpnpmバージョンは固定したい場合に有効です。
