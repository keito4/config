...
from common import (load_hook_input, parse_tool_context, is_bash_command,
                    ...
                    print_section, print_status, command_available, run_ai_command,
                    run_command, run_parallel_reviews)
...
def run_codex_review():
    ...
    return run_ai_command("Codex", codex_command, cwd=os.getcwd(), timeout=600)
...
{diff_content[:50000]}"""
        ...
        return run_ai_command("Gemini", gemini_command, cwd=os.getcwd(), timeout=600)
...
reviewers = {}
if has_codex:
    reviewers["codex"] = run_codex_review
if has_gemini:
    reviewers["gemini"] = run_gemini_review

review_results = {"codex": None, "gemini": None}
review_results.update(run_parallel_reviews(reviewers))
